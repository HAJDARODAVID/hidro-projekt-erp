                ...
                <div class="card login-card border-0 shadow-lg">
                    <div class="card-body px-md-5 py-4">
                        <div class="text-center mb-4">
                            ...
                            <hr>
                            <h1 class="h5 fw-bold mb-1">{{ __('Reset your password') }}</h1>
                            <p class="text-muted small mb-0">{{ __('Choose a new password for your account') }}</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('password.update') }}" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <input id="email" type="email" class="form-control border-start-0 ps-0 @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus placeholder="name@example.com">
